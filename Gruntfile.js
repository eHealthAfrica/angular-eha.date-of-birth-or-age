module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','date-of-birth-or-age');
        }
      }
    },
    concat: {
    ...
    uglify: {
      dist: {
        files: {
          'dist/date-of-birth-or-age.template.min.js': ['.tmp/scripts.template.js'],
          'dist/date-of-birth-or-age.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
      dist: {
        ...
        module: 'eha.date-of-birth-or-age.template',
        options: {
  ...
  grunt.registerTask('test:watch', ['template', 'karma:watch']);
